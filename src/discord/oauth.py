...
DEFAULT_SCOPES = "rpc+rpc.activities.write+openid+sdk.social_layer+sdk.social_layer_presence+rpc.screenshare.read+rpc.screenshare.write+rpc.video.write+rpc.voice.write+rpc.voice.read+rpc.notifications.read+rpc.video.read"
